        ...
        <CardHeader>
          <CardTitle className="text-xl flex items-center gap-3">
            ...
            <div className="flex items-center gap-3 ml-auto">
              <span className={`text-sm font-medium ${isBotActive ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {quickActions.map((action, index) => (
            <Card key={index} className="group hover:shadow-xl transition-all duration-300 cursor-pointer border-border/50 overflow-hidden">
